...
8. **Connor Hawke - Adapters**: Census/apportionment, NHL/icelines,
   ...
   MoneyPuck, paged NHL stats report, and Gamecenter batch acquisition plus
   query partition/rollup handoff reporting and query quiver handoff reporting.
   Product semantics remain in each consumer.
