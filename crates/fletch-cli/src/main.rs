...
use fletch_core::{
    ...
    cache_index_gate_report, cache_key, cache_list, dry_run_flight, export_quiver, fetch_plan,
    ...
    registry_index_from_registries, search_registry_index, slice_active_partition_set,
    slice_adapter_source_report, slice_archive_expansion_preview, slice_cache_index_report,
    slice_local_url_map, slice_mdcrop_index_report, slice_partition_state,
    ...
    tips_from_manifest, validate_registry, verify_cache_manifest, verify_quiver_bundle,
    ...
    match cli.command {
        ...
        Commands::Publish { command } => match command {
            ...
            PublishCommands::ProofDocs {
                ...
                let docs = proof_document_manifest(&mdcrop_index);
