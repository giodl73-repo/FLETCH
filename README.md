...
include a match snippet and score so users can see which ID, tag, metadata value,
or source URL made the row relevant. Click **Load preview** beside a source URL
to fetch bounded source data. Source previews include line-numbered sections,
