...
| Contract Checker | Foundation spec and code consistently name `fletch.crop-index.v1`, `fletch.proof-docs.v1`, `fletch.local-url-map.v1`, and `fletch.publisher-bundle.v1`. | Pass |
...
| F-I3 Data Integration | CROP/PROOF outputs remain backend-neutral and adapter-friendly. | Pass |
