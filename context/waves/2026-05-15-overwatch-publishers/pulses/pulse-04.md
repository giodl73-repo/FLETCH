...
downstream CROP/PROOF backends without replacing authoritative machine
contracts.

## Outcome

- Added `fletch.publisher-bundle.v1`.
- Summarized CROP row counts, PROOF document counts, local URL counts, and
  optional quiver/adapter counts.
- Added `fletch publish bundle --crop-index ... --proof-docs ... --local-url-map ...`.
