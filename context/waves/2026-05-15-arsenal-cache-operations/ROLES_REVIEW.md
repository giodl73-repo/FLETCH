...
| PROOF/MDCROP Publisher | Named report contracts (`cache-verify`, `cache-offline`, `cache-prune`) are directly indexable/renderable. | Pass |
...
| F-I6 Documentation Pipeline | Named report contracts are MDCROP/PROOF-ready. | Pass |
