...
| MDLOOM/MDCROP Publisher | Named report contracts (`cache-verify`, `cache-offline`, `cache-prune`) are directly indexable/renderable. | Pass |
...
| MDCROP Indexer | Named reports are stable corpus-health inputs for MDCROP indexing. | Pass |
...
| F-I6 Documentation Pipeline | Named report contracts are MDCROP/MDLOOM-ready. | Pass |
