...
| MDLOOM/CROP Publisher | CROP/MDLOOM can render or index compact ledger rows and change summaries while linking back to authoritative manifests. | Pass |
...
| F-I6 Documentation Pipeline | The index and diff schemas are suitable for generated CROP/MDLOOM/MDPATH status views. | Pass |
