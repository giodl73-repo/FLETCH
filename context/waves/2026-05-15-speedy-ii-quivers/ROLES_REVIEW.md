...
| MDLOOM/CROP Publisher | Quiver summaries, verification, graphs, and merge-ready rows are renderable/indexable local artifacts. | Pass |
...
| CROP Indexer | Quiver graph and status reports are direct corpus inputs for bundle health indexes. | Pass |
