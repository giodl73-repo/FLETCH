...
| 07 | Registry web browser | done | Added local `fletch registry web` search/detail/source-preview UI over registry indexes with direct launch, optional browser opening, sorted results, and paging. |
