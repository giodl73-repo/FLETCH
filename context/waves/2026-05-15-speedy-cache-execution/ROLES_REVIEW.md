...
| PROOF/CROP Publisher | Flights, tips, publish reports, ledgers, and stable pulse docs are renderable/indexable; generated docs remain views over contracts. | Pass |
...
| F-I6 Documentation Pipeline | CROP/PROOF-facing publish reports and docs are contract-derived, not source-of-truth replacements. | Pass |
