...
| 09 | Ledger output upsert | done | Upserted fetch output entries into existing manifests instead of overwriting ledgers. |
...
- FLETCH does not make generated MDCROP/PROOF views the source of truth.
