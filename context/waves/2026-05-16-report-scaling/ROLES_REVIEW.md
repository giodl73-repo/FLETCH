...
| PROOF/CROP Publisher | Smaller derived report slices are easier for CROP/PROOF backends to index or render while retaining links to machine contracts. | Pass |
