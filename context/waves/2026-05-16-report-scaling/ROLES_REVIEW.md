...
| MDLOOM/CROP Publisher | Smaller derived report slices are easier for CROP/MDLOOM backends to index or render while retaining links to machine contracts. | Pass |
...
| CROP Indexer | CROP can consume smaller report chunks for local corpus/status indexing. | Pass |
